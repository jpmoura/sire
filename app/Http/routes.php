...
*/
  ...
  Route::get('/alocacao/consulta', ['as' => 'getViewAllocDate', 'uses' => 'AllocationController@getViewAllocDate']);
  Route::post('/alocacao/consulta', ['as' => 'postViewAllocDate', 'uses' => 'AllocationController@showAllocationAt']);
