...
@section('title')
    Adicionar Fabricante de Software
@endsection
    ...
    <div class='row'>
        <div class='col-md-8 col-md-offset-2'>
            <div class="box box-primary-ufop">
                <div class="box-body">
                    <form class="form" action="{{ route('fabricante.store') }}" accept-charset="UTF-8" method="post">
                        {{ csrf_field() }}

                        <div class="form-group {{ $errors->has('nome') ? 'has-error' : '' }}">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-tag"></i></span>
                                <input type="text" name="nome" maxlength="255" class="form-control" placeholder="Nome do fabricante" title="Nome do fabricante" value="{{ old('nome') }}" required>
                            </div>
                            @if ($errors->has('nome'))
