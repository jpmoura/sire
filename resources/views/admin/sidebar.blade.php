    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          @if(Session::get("nivel") == 1)
            ...
            <li @if(Session::get("menu") == "viewReserva") class="active" @endif><a href="{{url('/alocacao/consulta')}}"><i class="fa fa-search" aria-hidden="true"></i><span>Consultar Reserva</span></a></li>
