...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        @if(Route::is('showRule')) disabled @endif>
    </div>
    <div class="input-group">
        ...
        <input type="text" max="5" min="5" name="horario_inicio_matutino" class="form-control" value="{{ $regras->horario_inicio_matutino }}"
               ...
               title="Horário de início do turno matutino no formato 24h. Ex.: 08:00" @if(Route::is('showRule')) disabled @endif>
    </div>
</div>
...
<div class="form-group">
    ...
    <div class="input-group">
        ...
        <input type="number" class="form-control" min="0" max="5" value="{{ $regras->quantidade_horarios_vespertino }}"
               ...
               data-placement="right" title="Quantidade de horários disponíveis no turmo verpertino" @if(Route::is('showRule')) disabled @endif>
    </div>
    <div class="input-group">
        <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
        <input type="text" name="horario_inicio_vespertino" class="form-control"
               ...
               required data-toggle="tooltip" data-placement="right"
               title="Horário de início do turno vespertino no formato 24h. Ex.: 14:20" @if(Route::is('showRule')) disabled @endif>
    </div>
</div>
