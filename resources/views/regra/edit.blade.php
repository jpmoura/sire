    ...
    <div class='row'>
        <div class='col-md-8 col-md-offset-2'>
            <div class="box box-primary-ufop">
                <div class="box-body">
                    <form class="form" action="{{ route('editRule') }}" accept-charset="UTF-8" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" type="number" min="0" max="6" value="{{ $regras->quantidade_horarios_matutino }}" placeholder="Quantidade de horários durante a manhã" required name="manha" data-toggle="tooltip" data-placement="right" title="Quantidade de horários disponíveis no turmo matutino">
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                <input type="text" max="5" min="5" name="inicioManha" class="form-control" value="{{ $regras->horario_inicio_matutino }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="number" class="form-control" min="0" max="5" value="{{ $regras->quantidade_horarios_vespertino }}" placeholder="Quantidade de horários durante a tarde" name="tarde" required data-toggle="tooltip" data-placement="right" title="Quantidade de horários disponíveis no turmo verpertino">
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <input type="number" class="form-control" min="0" max="4" value="{{ $regras->quantidade_horarios_noturno }}" placeholder="Quantidade de horários durante a noite" name="noite" required data-toggle="tooltip" data-placement="right" title="Quantidade de horários disponíveis no turmo noturno">
                            </div>
                            <div class="input-group">
                                <span class="input-group-addon"><i class="fa fa-clock-o"></i></span>
                                <input type="text" name="inicioNoite" class="form-control" placeholder="Horário de início do turno noturno no formato 24h. Ex.: 19:20" value="{{ $regras->horario_inicio_noturno }}"
