    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            @can('administrate')
                ...
                <li @if(Route::is('reserva.show.date') || Route::is('recurso.select.date')) class="active" @endif><a href="{{ route('recurso.select.date') }}"><i class="fa fa-search" aria-hidden="true"></i><span>Consultar Reserva</span></a></li>
                ...
                <li><a href="{{ route('log.index') }}" target="_blank"><i class="fa fa-database" aria-hidden="true"></i><span>Logs</span></a></li>
            @endcan

            @if(Auth::check())
                <li class="header text-center">MENU</li>
                <li @if(Route::is("reserva.show") || Route::is('recurso.select')) class="active" @endif><a href="{{ route('recurso.select') }}"><i class="fa fa-calendar-plus-o" aria-hidden="true"></i><span>Alocar Recurso</span></a></li>
