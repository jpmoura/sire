  ...
  <div class="row">
    <div class="col-md-6 col-md-offset-3">
      <p class="text-justify">
        O Sistema de Reserva de Salas e Equipamentos é o sistema da <a href="http://ufop.br">Universidade Federal de Ouro Preto</a> do
        <a href="http://www.icea.ufop.br/site/"><em>campus</em> João Monlevade</a> usado por professores e corpo administrativo para realizar a alocação dos recursos
        existentes de acordo com as datas e horários disponíveis.
        <br />
        O novo sistema foi refeito pelo bolsista <a href="https://github.com/jpmoura">João Pedro Santos de Moura</a>  devido a necessidade de se atualizar tanto a interface com o usuário quanto as ferramentas
        ...
        <section id="modificacoes">
          ...
          <ul>
            ...
            <li>Uso do <em>framework</em> <a href="https://laravel.com/">Laravel</a>, um dos framworks mais famosos no período em que o sistema foi desenvolvido</li>
            <li>Uso da arquitetura MVC para desenvolvimento, com o objetivo de facilitar a manutenção e atualização;</li>
            <li>Utilização do padrão mais recente do HTML de acordo com o <a href="https://www.w3.org/html/">W3C</a>;</li>
          </ul>
        </section>

        <h3 class="text-center">A Fazer</h3>
        <ul>
          <li>Alterar o motor de login para utilizar um login único com base no sistema <a href="http://www.minha.ufop.br/">Minha UFOP</a>;</li>
